;;; usgc-reticle-st-theme.el --- USGC-RETICLE-ST color theme for Emacs -*- lexical-binding: t; -*- no-byte-compile: t;
...
;; This theme is a port of the "USGC-RETICLE-ST" color scheme originally
...
(deftheme usgc-reticle-st
  "USGC-RETICLE-ST color theme")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Base settings - Dark theme with black background, green foreground
   `(default                  ((,class (:background ,black :foreground ,green))))
   `(cursor                   ((,class (:background ,white))))
   `(region                   ((,class (:background ,white :foreground ,fl-blue))))
   `(hl-line                  ((,class (:background ,fl-blue))))
   `(fringe                   ((,class (:background ,black :foreground ,fl-red))))
   `(linum                    ((,class (:background ,black :foreground ,fl-red))))
   `(line-number              ((,class (:inherit default :background ,black :foreground ,fl-red))))
   `(line-number-current-line ((,class (:inherit default :background ,fl-blue :foreground ,white))))

   ;; Mode line
   `(mode-line ((,class (:background ,blue
                                     :foreground ,black
                                     :box (:line-width 1 :color ,fl-green :style flat-button)))))
   ...
   ;; Company
   `(company-tooltip ((,class (:background ,black :foreground ,green))))
   `(company-tooltip-selection ((,class (:background ,white :foreground ,fl-blue))))
   `(company-tooltip-common ((,class (:foreground ,fl-blue :weight bold))))
   `(company-tooltip-common-selection ((,class (:background ,white :foreground ,fl-blue :weight bold))))

   ;; Ivy
   `(ivy-current-match ((,class (:background ,white :foreground ,fl-blue))))
   ...
   ;; Helm
   `(helm-selection ((,class (:background ,white :foreground ,fl-blue))))
   ...
   ;; Link
   `(link ((,class (:foreground ,fl-yellow :underline t))))
   `(link-visited ((,class (:foreground ,fl-magenta :underline t))))

   ;; Header line
   `(header-line ((,class (:background ,black :foreground ,green :box nil))))

   ;; Tab line
   `(tab-line ((,class (:background ,green :foreground ,black))))
   `(tab-line-tab ((,class (:background ,black :foreground ,green :weight bold))))
   `(tab-line-tab-current ((,class (:background ,black :foreground ,green :weight bold))))

   ;; Centaur tabs
   `(centaur-tabs-selected ((,class (:background ,black :foreground ,green :weight bold :underline nil))))
   `(centaur-tabs-unselected ((,class (:background ,yellow :foreground ,black))))
   `(centaur-tabs-selected-modified ((,class (:background ,black :foreground ,green :weight bold :underline nil))))
   `(centaur-tabs-unselected-modified ((,class (:background ,gray :foreground ,black))))


   ;; Powerline (if used)
   `(powerline-active1 ((,class (:background ,black :foreground ,green))))
   ...
   `(dashboard-items-face ((,class (:foreground ,green))))

   ;; Calendar
   `(calendar-today ((,class (:background ,white :foreground ,fl-blue))))
   ...
   `(term-default-fg ((,class (:foreground ,green))))
   ...
   ;; Prog mode
   `(prog-mode-face ((,class (:foreground ,green))))
   ...
   `(highlight-current-symbol-face ((,class (:background ,white :foreground ,fl-blue))))
   ...
   ;; Multiple cursors
   `(multiple-cursors ((,class (:background ,white :foreground ,fl-blue))))
   ...
   `(undo-tree-visualizer-default-face ((,class (:foreground ,green))))
   ...
   `(neo-file-link-face ((,class (:foreground ,green))))
   ...
   `(treemacs-file-face ((,class (:foreground ,green))))
   ...
   `(doom-modeline-buffer-path ((,class (:foreground ,green :weight bold))))
   `(doom-modeline-buffer-file ((,class (:foreground ,green :weight bold))))
   ...
   ;; Solaire mode
   `(solaire-default-face ((,class (:background ,black :foreground ,green))))
   `(solaire-minibuffer-face ((,class (:background ,black :foreground ,green))))
   `(solaire-hl-line-face ((,class (:background ,fl-blue))))
   `(solaire-org-hide-face ((,class (:foreground ,black))))

   ;; Consult
   `(consult-preview-insertion ((,class (:background ,white :foreground ,fl-blue))))
   `(consult-preview-line ((,class (:background ,fl-yellow :foreground ,black))))

   ;; Corfu
   `(corfu-default ((,class (:background ,black :foreground ,green))))
   `(corfu-current ((,class (:background ,white :foreground ,fl-blue))))
   ...
   ;; Vertico
   `(vertico-current ((,class (:background ,white :foreground ,fl-blue))))
   ...
   ;; Recentf
   `(recentf-item ((,class (:foreground ,green))))

   ;; Bookmark
   `(bookmark-menu-bookmark ((,class (:foreground ,green))))
   `(bookmark-menu-heading ((,class (:foreground ,green :weight bold))))

   ;; Buffer menu
   `(Buffer-menu-buffer ((,class (:foreground ,green))))
   ...
   `(lsp-face-highlight-textual ((,class (:background ,white :foreground ,fl-blue))))
   ...
   `(tree-sitter-hl-face:function.call ((,class (:foreground ,green))))
   ...
   `(tree-sitter-hl-face:method.call ((,class (:foreground ,green))))
   ...
   `(tree-sitter-hl-face:punctuation.bracket ((,class (:foreground ,green))))
   ...
   `(cedet-format-tag-variable ((,class (:foreground ,green))))
   `(cedet-format-tag-type ((,class (:foreground ,magenta))))
   `(cedet-format-tag-class ((,class (:foreground ,fl-blue :weight bold))))

   ;; EDE
   `(ede-tab-active ((,class (:background ,black :foreground ,green :weight bold :underline t))))
   ...
   ;; Debugger
   `(debugger-locals ((,class (:foreground ,green))))
   ...
   ;; Edebug
   `(edebug-enabled-face ((,class (:background ,white :foreground ,fl-blue))))
   ...
   ;; Tar mode
   `(tar-file ((,class (:foreground ,green))))
   ...
   `(xref-found ((,class (:foreground ,green))))
   `(xref-match ((,class (:background ,fl-yellow :foreground ,black))))

   ;; Yank
   `(yank ((,class (:background ,white :foreground ,fl-blue))))

   ;; Zebra
   `(zebra ((,class (:background ,white))))
   ...
   `(ztree-diff-model-normal ((,class (:foreground ,green))))
   ...
   `(ztree-last-node ((,class (:foreground ,green))))
   `(ztree-node ((,class (:foreground ,green))))
   `(ztree-leaf ((,class (:foreground ,green))))
...
(provide-theme 'usgc-reticle-st)

;; End:

;;; usgc-reticle-st-theme.el ends here
