;;; usgc-high-k-st-theme.el --- USGC-HIGH-K-ST color theme for Emacs -*- lexical-binding: t;  -*- no-byte-compile: t;
...
(deftheme usgc-high-k-st
  "USGC-HIGH-K-ST color theme")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor                   ((,class (:background ,fl-blue))))
   `(region                   ((,class (:background ,fl-green :foreground ,black))))
   `(hl-line                  ((,class (:background ,fl-green))))
   `(fringe                   ((,class (:background ,white :foreground ,fl-red))))
   `(linum                    ((,class (:background ,white :foreground ,fl-red))))
   `(line-number              ((,class (:inherit default :background ,white :foreground ,fl-red))))
   `(line-number-current-line ((,class (:inherit default :background ,fl-green :foreground ,black))))

   ;; Mode line
   `(mode-line ((,class (:background ,fl-blue
                                     :foreground ,white
                                     :box nil))))
   `(mode-line-inactive ((,class (:background ,gray
                                              :foreground ,black
                                              :box nil))))
   ...
   ;; Minibuffer
   `(minibuffer-prompt ((,class (:foreground ,fl-blue))))

   ;; Font lock (syntax highlighting)
   `(font-lock-builtin-face       ((,class (:foreground ,fl-blue))))
   `(font-lock-comment-face       ((,class (:foreground ,gray))))
   `(font-lock-constant-face      ((,class (:foreground ,fl-blue))))
   `(font-lock-doc-face           ((,class (:foreground ,gray))))
   `(font-lock-function-name-face ((,class (:foreground ,black :weight bold))))
   `(font-lock-keyword-face       ((,class (:foreground ,fl-blue))))
   `(font-lock-string-face        ((,class (:foreground ,green))))
   `(font-lock-type-face          ((,class (:foreground ,fl-blue :weight bold))))
   `(font-lock-variable-name-face ((,class (:foreground ,black))))
   `(font-lock-warning-face       ((,class (:foreground ,fl-red :weight bold))))
   ...
   ;; Tooltips
   `(tooltip ((,class (:background ,black :foreground ,white))))

   ;; Match
   `(match ((,class (:background ,fl-yellow :foreground ,black))))

   ;; Lazy highlight
   `(lazy-highlight ((,class (:background ,fl-cyan :foreground ,black))))
   ...
   ;; Rainbow delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:foreground ,black))))
   ...
   `(magit-diff-hunk-heading ((,class (:background ,yellow :foreground ,black))))

   ;; Company
   `(company-tooltip                  ((,class (:background ,white :foreground ,black))))
   `(company-tooltip-selection        ((,class (:background ,fl-green :foreground ,black))))
   `(company-tooltip-common           ((,class (:foreground ,blue :weight bold))))
   `(company-tooltip-common-selection ((,class (:background ,fl-green :foreground ,blue :weight bold))))

   ;; Ivy
   `(ivy-current-match ((,class (:background ,fl-green :foreground ,black))))
   `(ivy-minibuffer-match-face-1 ((,class (:background ,fl-yellow :foreground ,black))))
   `(ivy-minibuffer-match-face-2 ((,class (:background ,fl-cyan :foreground ,black))))

   ;; Helm
   `(helm-selection ((,class (:background ,fl-green :foreground ,black))))
   ...
   `(ediff-fine-diff-B ((,class (:background ,fl-cyan :foreground ,black))))
   ...
   `(widget-button ((,class (:weight bold :foreground ,blue))))
   `(widget-button-pressed ((,class (:foreground ,fl-red))))

   ;; Button
   `(button ((,class (:weight bold :foreground ,blue))))

   ;; Link
   `(link ((,class (:foreground ,fl-blue :underline t))))
   `(link-visited ((,class (:foreground ,fl-magenta :underline t))))

   ;; Header line
   `(header-line ((,class (:background ,white :foreground ,black :box nil))))

   ;; Tab line
   `(tab-line ((,class (:background ,green :foreground ,black))))
   `(tab-line-tab ((,class (:background ,white :foreground ,black :weight bold))))
   `(tab-line-tab-current ((,class (:background ,white :foreground ,black :weight bold))))

   ;; Centaur tabs
   `(centaur-tabs-selected ((,class (:background ,white :foreground ,black :weight bold :underline nil))))
   `(centaur-tabs-unselected ((,class (:background ,yellow :foreground ,black))))
   `(centaur-tabs-selected-modified ((,class (:background ,white :foreground ,black :weight bold :underline nil))))
   `(centaur-tabs-unselected-modified ((,class (:background ,gray :foreground ,black))))

   ;; Powerline (if used)
   `(powerline-active1 ((,class (:background ,white :foreground ,black))))
   `(powerline-active2 ((,class (:background ,white :foreground ,gray))))
   `(powerline-inactive1 ((,class (:background ,white :foreground ,gray))))
   `(powerline-inactive2 ((,class (:background ,white :foreground ,gray))))

   ;; Dashboard
   `(dashboard-banner-logo-title ((,class (:foreground ,green :weight bold :height 1.2))))
   `(dashboard-items-face ((,class (:foreground ,black))))

   ;; Calendar
   `(calendar-today ((,class (:background ,fl-green :foreground ,black))))
   ...
   `(gnus-header-subject ((,class (:foreground ,black))))
   ...
   `(message-header-subject ((,class (:foreground ,black :weight bold))))
   ...
   `(term-color-cyan ((,class (:foreground ,fl-cyan :background ,fl-cyan))))
   `(term-color-white ((,class (:foreground ,white :background ,white))))
   `(term-default-fg ((,class (:foreground ,black))))
   `(term-default-bg ((,class (:background ,white))))

   ;; Man
   `(Man-overstrike ((,class (:foreground ,green :weight bold))))
   `(Man-underline ((,class (:foreground ,blue :underline t))))

   ;; Info
   `(info-title-1 ((,class (:foreground ,green :weight bold :height 1.4))))
   `(info-title-2 ((,class (:foreground ,blue :weight bold :height 1.2))))
   ...
   `(outline-2 ((,class (:foreground ,blue :weight bold))))
   ...
   `(font-latex-italic-face ((,class (:foreground ,blue :slant italic))))
   `(font-latex-math-face ((,class (:foreground ,magenta))))
   `(font-latex-sectioning-0-face ((,class (:foreground ,green :weight bold))))
   `(font-latex-sectioning-1-face ((,class (:foreground ,blue :weight bold))))
   ...
   `(python-rx-const-face ((,class (:foreground ,fl-cyan))))

   ;; JSON
   `(json-key ((,class (:foreground ,blue :weight bold))))
   ...
   ;; Web mode
   `(web-mode-html-tag-face ((,class (:foreground ,blue :weight bold))))
   ...
   `(markdown-header-face-2 ((,class (:foreground ,blue :weight bold :height 1.1))))
   ...
   `(lisp-keyword-face ((,class (:foreground ,blue :weight bold))))

   ;; Elisp
   `(elisp-byte-code-face ((,class (:foreground ,fl-cyan))))

   ;; Prog mode
   `(prog-mode-face ((,class (:foreground ,black))))

   ;; Whitespace
   `(whitespace-space ((,class (:foreground ,gray :background ,white))))
   `(whitespace-tab ((,class (:foreground ,gray :background ,white))))
   `(whitespace-newline ((,class (:foreground ,gray :background ,white))))
   ...
   `(column-marker-2 ((,class (:background ,fl-cyan))))
   ...
   `(highlight-current-symbol-face ((,class (:background ,fl-green :foreground ,black))))
   ...
   ;; Multiple cursors
   `(multiple-cursors ((,class (:background ,fl-green :foreground ,black))))

   ;; Avy (Jump navigation)
   `(avy-lead-face ((,class (:background ,fl-yellow :foreground ,black :weight bold :box nil))))
   ...
   `(avy-background-face ((,class (:background ,gray :foreground ,black))))
   ...
   `(undo-tree-visualizer-default-face ((,class (:foreground ,black))))
   ...
   `(neo-file-link-face ((,class (:foreground ,black))))
   ...
   `(treemacs-file-face ((,class (:foreground ,black))))
   ...
   `(diredp-dir-name ((,class (:foreground ,blue :weight bold))))
   ...
   `(all-the-icons-cyan ((,class (:foreground ,fl-cyan))))
   ...
   `(doom-modeline-buffer-path ((,class (:foreground ,black :weight bold))))
   `(doom-modeline-buffer-file ((,class (:foreground ,black :weight bold))))
   `(doom-modeline-project-root ((,class (:foreground ,green :weight bold))))
   `(doom-modeline-project-doom ((,class (:foreground ,blue :weight bold))))
   ...
   ;; Solaire mode
   `(solaire-default-face ((,class (:background ,white :foreground ,black))))
   `(solaire-minibuffer-face ((,class (:background ,white :foreground ,black))))
   `(solaire-hl-line-face ((,class (:background ,fl-green))))
   `(solaire-org-hide-face ((,class (:foreground ,white))))

   ;; Consult
   `(consult-preview-insertion ((,class (:background ,fl-green :foreground ,black))))
   `(consult-preview-line ((,class (:background ,fl-yellow :foreground ,black))))

   ;; Corfu
   `(corfu-default ((,class (:background ,white :foreground ,black))))
   `(corfu-current ((,class (:background ,fl-green :foreground ,black))))

   ;; Orderless
   `(orderless-match-face-0 ((,class (:foreground ,white :background ,fl-red :weight bold))))
   `(orderless-match-face-1 ((,class (:foreground ,white :background ,fl-orange :weight bold))))
   ...
   ;; Marginalia
   `(marginalia-char ((,class (:foreground ,fl-cyan))))
   `(marginalia-date ((,class (:foreground ,maroon))))
   `(marginalia-documentation ((,class (:foreground ,olive))))
   `(marginalia-key ((,class (:foreground ,fl-red))))
   `(marginalia-number ((,class (:foreground ,blue))))
   `(marginalia-symbol ((,class (:foreground ,magenta))))
   ...
   ;; Vertico
   `(vertico-current ((,class (:background ,fl-green :foreground ,black))))
   ...
   ;; Recentf
   `(recentf-item ((,class (:foreground ,black))))

   ;; Bookmark
   `(bookmark-menu-bookmark ((,class (:foreground ,black))))
   `(bookmark-menu-heading ((,class (:foreground ,green :weight bold))))

   ;; Buffer menu
   `(Buffer-menu-buffer ((,class (:foreground ,black))))
   ...
   ;; Evil
   `(evil-ex-lazy-highlight ((,class (:background ,fl-cyan :foreground ,black))))
   ...
   `(lsp-face-highlight-textual ((,class (:background ,fl-green :foreground ,black))))
   ...
   `(tree-sitter-hl-face:function.call ((,class (:foreground ,black))))
   ...
   `(tree-sitter-hl-face:method.call ((,class (:foreground ,black))))
   ...
   `(tree-sitter-hl-face:punctuation.bracket ((,class (:foreground ,black))))
   ...
   `(tree-sitter-hl-face:tag ((,class (:foreground ,blue :weight bold))))
   `(tree-sitter-hl-face:type ((,class (:foreground ,magenta))))
   `(tree-sitter-hl-face:type.parameter ((,class (:foreground ,cyan))))
   `(tree-sitter-hl-face:variable ((,class (:foreground ,black))))
   `(tree-sitter-hl-face:variable.parameter ((,class (:foreground ,cyan))))

   ;; Semantic
   `(semantic-tag-func ((,class (:foreground ,green :weight bold))))
   `(semantic-tag-var ((,class (:foreground ,black))))
   `(semantic-tag-type ((,class (:foreground ,magenta))))
   `(semantic-tag-keyword ((,class (:foreground ,blue :weight bold))))

   ;; CEDET
   `(cedet-format-tag-function ((,class (:foreground ,green :weight bold))))
   `(cedet-format-tag-variable ((,class (:foreground ,black))))
   `(cedet-format-tag-type ((,class (:foreground ,magenta))))
   `(cedet-format-tag-class ((,class (:foreground ,blue :weight bold))))

   ;; EDE
   `(ede-tab-active ((,class (:background ,white :foreground ,black :weight bold :underline t))))
   `(ede-tab-inactive ((,class (:background ,white :foreground ,gray))))

   ;; Speedbar
   `(speedbar-button-face ((,class (:foreground ,blue :weight bold))))
   `(speedbar-file-face ((,class (:foreground ,black))))
   ...
   `(imenu-list-entry-face-1 ((,class (:foreground ,blue :weight bold))))
   ...
   `(compilation-column-number ((,class (:foreground ,fl-cyan))))

   ;; Debugger
   `(debugger-locals ((,class (:foreground ,black))))
   `(debugger-stack-frame ((,class (:foreground ,green :weight bold))))

   ;; Profiler
   `(profiler-called-function-name ((,class (:foreground ,green :weight bold))))
   `(profiler-calling-function-name ((,class (:foreground ,blue :weight bold))))

   ;; Edebug
   `(edebug-enabled-face ((,class (:background ,fl-green :foreground ,black))))
   ...
   ;; Tar mode
   `(tar-file ((,class (:foreground ,black))))
   `(tar-header ((,class (:foreground ,blue :weight bold))))
   ...
   ;; Version control
   `(vc-dir-file-name ((,class (:foreground ,black))))
   `(vc-dir-header ((,class (:foreground ,green :weight bold))))
   `(vc-dir-marked ((,class (:foreground ,fl-green :weight bold))))

   ;; View
   `(view ((,class (:foreground ,black))))

   ;; Visible bookmarks
   `(visible-bookmark ((,class (:background ,fl-yellow :foreground ,black))))

   ;; Widget
   `(widget ((,class (:foreground ,black))))

   ;; Window
   `(window ((,class (:foreground ,black))))

   ;; Woman
   `(woman-bold ((,class (:foreground ,green :weight bold))))
   `(woman-italic ((,class (:foreground ,blue :slant italic))))

   ;; Xref
   `(xref-file-header ((,class (:foreground ,green :weight bold))))
   `(xref-file-prefix ((,class (:foreground ,blue))))
   `(xref-found ((,class (:foreground ,black))))
   `(xref-match ((,class (:background ,fl-yellow :foreground ,black))))

   ;; Yank
   `(yank ((,class (:background ,fl-green :foreground ,black))))

   ;; Zebra
   `(zebra ((,class (:background ,fl-green))))
   ...
   `(ztree-diff-model-normal ((,class (:foreground ,black))))
   `(ztree-diff-node ((,class (:foreground ,blue :weight bold))))
   `(ztree-expand-sign ((,class (:foreground ,gray))))
   `(ztree-header ((,class (:foreground ,green :weight bold))))
   `(ztree-last-node ((,class (:foreground ,black))))
   `(ztree-node ((,class (:foreground ,black))))
   `(ztree-leaf ((,class (:foreground ,black))))
...
(provide-theme 'usgc-high-k-st)

;; End:

;;; usgc-high-k-st-theme.el ends here
