...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box nil :background ,blue-3 :foreground ,white-0))))
   ...
   `(org-block ((,class (:foreground ,white-0 :background ,black-4))))
   ...
   `(org-block-end-line ((,class (:foreground ,white-0 :background ,blue-3 :extend nil))))
