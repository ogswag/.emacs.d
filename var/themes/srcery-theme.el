;;; srcery-theme.el --- Dark color theme -*- lexical-binding: t; -*- no-byte-compile: t;
;; Copyright (C) 2019 Daniel Berg

;; Author: Daniel Berg
;; URL: https://github.com/srcery-colors/srcery-emacs

;; Package-Version: 20250901.1751
;; Package-Revision: eee86865bb7b
;; Keywords: faces
...
(let* ((srcery-class '((class color) (min-colors 257)))
  ...
  (custom-theme-set-faces
   ...
   `(line-number
     ((,srcery-class (:inherit default :foreground ,srcery-bright-black :background ,srcery-black))
      (,srcery-256-class (:foreground ,srcery-256-bright-black :background ,(if srcery-transparent-background 'unspecified srcery-256-black)))))

   `(line-number-current-line
     ((,srcery-class (:inherit default :foreground ,srcery-yellow))
      (,srcery-256-class (:foreground ,srcery-256-yellow))))
